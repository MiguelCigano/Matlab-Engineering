...
##beta=0.00202;                                  %Parámetro de sintonización en el DG
beta=0.0102; 

%Señal de exitación-------------------------------------------------------------

[inp,wk] = michirp(0.01,690000,T+1,0.05);        %(f. inicial, f. final, muestras, intervalos)
...
xlabel("tiempo [ k ]")
line([final_ruido final_ruido], [0 1.5*max(x(1,1:datos+1))], "linestyle", "--", "linewidth", 2,  "color", "black")
xlim ([0, datos])

title({"Algoritmo PI - control óptimo adaptativo" "Muestras" T "Experimento" exp})
...
line([0 exp], [P0(1,1) P0(1,1)], "linestyle", "--", "linewidth", 2, "color", "r")
line([0 exp], [P0(1,2) P0(1,2)], "linestyle", "--", "linewidth", 2, "color", "m")
line([0 exp], [P0(2,2) P0(2,2)], "linestyle", "--", "linewidth", 2,"color", "black")
...
line([0 num_exp], [K0(1,1) K0(1,1)], "linestyle", "--", "linewidth", 2, "color", "r")
line([0 num_exp], [K0(1,2) K0(1,2)], "linestyle", "--", "linewidth", 2, "color", "b")
